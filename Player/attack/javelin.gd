...
var sprint_jav_reg = preload("res://Textures/Items/Weapons/javelin_3_new.png")
var sprint_jav_atack = preload("res://Textures/Items/Weapons/javelin_3_new_attack.png")
...
func enable_attack(attack = true):
	if attack:
		...
		sprite.texture = sprint_jav_atack
	else:
		collision.call_deferred("set", "disable", true)
		sprite.texture = sprint_jav_reg
